...
public class ImageResizer extends ImageWorker {
    ...
    public static Bitmap decodeSampledBitmapFromResource(Resources res, int resId,
        ...
        return BitmapFactory.decodeResource(res, resId, options);
            ...
            Log.e(TAG, "decodeSampledBitmapFromResource - OutOfMemoryError"
                    + e);
        } finally {
    ...
    public static Bitmap decodeSampledBitmapFromFile(String filename,
        ...
        LogUtils.d("before decode image File:" + options.outWidth + "|" + options.outHeight);
...
//        options.inSampleSize = calculateInSampleSize(options, reqWidth, reqHeight);
        ...
        try {
             ...
             LogUtils.d("after decode image File:" + options.outWidth + "|" + options.outHeight);
             return val;
        } catch (Exception e) {
...
//                reqHeight);
        options.inSampleSize = calculateInSampSize(options, reqWidth,
                reqHeight);
        ...
        try{
            ...
            Log.e(TAG, "decodeSampledBitmapFromDescriptor - OutOfMemoryError"
                    + e);
        }finally {
